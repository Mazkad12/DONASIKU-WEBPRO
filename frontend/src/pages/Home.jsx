                ...
                <div className="relative bg-white/80 backdrop-blur-xl rounded-[2rem] shadow-2xl overflow-hidden border border-white/50">
                  <div className="relative h-[500px]">
                    {showcaseImages.map((slide, index) => (
                      <div
                        key={index}
                        className={`absolute inset-0 transition-all duration-700 ${index === currentSlide ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
                          }`}
                      >
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-fr">
            {bentoFeatures.map((feature, index) => (
              <div
                key={index}
                className={`group relative ${feature.size === 'large' ? 'lg:col-span-2 lg:row-span-1' : 'lg:col-span-1'
